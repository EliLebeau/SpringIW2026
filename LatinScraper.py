...
def main():
    ...
    for i in range(1,151):
        url = 'https://vulgate.org/ot/psalms_'+str(i)+'.htm'
        response = requests.get(url)
        soup = BeautifulSoup(response.text, 'html.parser')

        translation[i] = []
        gallican_psalm = soup.find_all(class_ = 'Jerome')
        for verse in gallican_psalm:
            translation[i].append(verse.text.strip())

    #     gallican[i] = []
    #     gallican_psalm = soup.find_all(class_ = 'Gallicana')
    #     for verse in gallican_psalm:
    #         gallican[i].append(verse.text.strip())

    #     hebrew[i] = []
    #     hebrew_psalm = soup.find_all(class_ = 'Latin')
    #     for verse in hebrew_psalm:
    #         hebrew[i].append(verse.text.strip())
...
#  2: ['למה רגשו גוים ולאמים יהגו־ריק',
...
#  3: ['מזמור לדוד בברחו מפני אבשלום בנו',
...
#   'יהוה נחני בצדקתך למען שוררי הישר לפני דרכך',
...
#  6: ['למנצח בנגינות על־השמינית מזמור לדוד',
...
#  7: ['שגיון לדוד אשר־שר ליהוה על־דברי־כוש בן־ימיני',
...
#  10: ['למה יהוה תעמד ברחוק תעלים לעתות בצרה',
...
#  11: ['למנצח לדוד ביהוה חסיתי איך תאמרו לנפשי נודי הרכם צפור',
...
#  12: ['למנצח על־השמינית מזמור לדוד',
...
#  14: ['למנצח לדוד אמר נבל בלבו אין אלהים השחיתו התעיבו עלילה אין עשה־טוב',
...
#  15: ['מזמור לדוד יהוה מי־יגור באהלך מי־ישכן בהר קדשך',
...
#  16: ['מכתם לדוד שמרני אל כי־חסיתי בך',
...
#  17: ['תפלה לדוד שמעה יהוה צדק הקשיבה רנתי האזינה תפלתי בלא שפתי מרמה',
...
#   'ממתים ידך יהוה ממתים מחלד חלקם בחיים וצפונך תמלא בטנם ישבעו בנים והניחו יתרם לעולליהם',
#   'אני בצדק אחזה פניך אשבעה בהקיץ תמונתך'],
#  18: ['למנצח לעבד יהוה לדוד אשר דבר ליהוה את־דברי השירה הזאת ביום הציל־יהוה אותו מכף כל־איביו ומיד שאול',
...
#  21: ['למנצח מזמור לדוד',
#   'יהוה בעזך ישמח־מלך ובישועתך מה־יגל מאד',
...
#  22: ['למנצח על־אילת השחר מזמור לדוד',
...
#  23: ['מזמור לדוד יהוה רעי לא אחסר',
...
#  24: ['לדוד מזמור ליהוה הארץ ומלואה תבל וישבי בה',
...
#   'זה דור דרשיו מבקשי פניך יעקב סלה',
...
#  26: ['לדוד שפטני יהוה כי־אני בתמי הלכתי וביהוה בטחתי לא אמעד',
#   'בחנני יהוה ונסני צרפה כליותי ולבי',
...
#  27: ['לדוד יהוה אורי וישעי ממי אירא יהוה מעוז־חיי ממי אפחד',
...
#  28: ['לדוד אליך יהוה אקרא צורי אל־תחרש ממני פן־תחשה ממני ונמשלתי עם־יורדי בור',
...
#  29: ['מזמור לדוד הבו ליהוה בני אלים הבו ליהוה כבוד ועז',
...
#  32: ['לדוד משכיל אשרי נשוי־פשע כסוי חטאה',
...
#  33: ['רננו צדיקים ביהוה לישרים נאוה תהלה',
...
#  34: ['לדוד בשנותו את־טעמו לפני אבימלך ויגרשהו וילך',
...
#  35: ['לדוד ריבה יהוה את־יריבי לחם את־לחמי',
...
#  37: ['לדוד אל־תתחר במרעים אל־תקנא בעשי עולה',
...
#   'ומשלמי רעה תחת טובה ישטנוני תחת רדפי־טוב',
#   'אל־תעזבני יהוה אלהי אל־תרחק ממני',
#   'חושה לעזרתי אדני תשועתי'],
#  39: ['למנצח לידותון מזמור לדוד',
...
#   'יהוה ישמרהו ויחיהו ואשר בארץ ואל־תתנהו בנפש איביו',
...
#  43: ['שפטני אלהים וריבה ריבי מגוי לא־חסיד מאיש־מרמה ועולה תפלטני',
...
#  45: ['למנצח על־ששנים לבני־קרח משכיל שיר ידידת',
...
#  46: ['למנצח לבני־קרח על־עלמות שיר',
...
#  50: ['מזמור לאסף אל א\u200dלהים יהוה דבר ויקרא־ארץ ממזרח־שמש עד־מבאו',
...
#   ' ישי מות עלימו ירדו שאול חיים כי־רעות במגורם בקרבם',
...
#  56: ['למנצח על־יונת אלם רחקים לדוד מכתם באחז אתו פלשתים בגת',
#   'חנני אלהים כי־שאפני אנוש כל־היום לחם ילחצני',
#   'שאפו שוררי כל־היום כי־רבים לחמים לי מרום',
#   'יום אירא אני אליך אבטח',
#   'באלהים אהלל דברו באלהים בטחתי לא אירא מה־יעשה בשר לי',
#   'כל־היום דברי יעצבו עלי כל־מחשבתם לרע',
#   'יגורו יצפונו המה עקבי ישמרו כאשר קוו נפשי',
...
#  57: ['למנצח אל־תשחת לדוד מכתם בברחו מפני־שאול במערה',
...
#   'ימאסו כמו־מים יתהלכו־למו ידרך חציו כמו יתמללו',
#   'כמו שבלול תמס יהלך נפל אשת בל־חזו שמש',
#   'בטרם יבינו סירתיכם אטד כמו־חי כמו־חרון ישערנו',
#   'ישמח צדיק כי־חזה נקם פעמיו ירחץ בדם הרשע',
#   'ויאמר אדם אך־פרי לצדיק אך יש־אלהים שפטים בארץ'],
#  59: ['למנצח אל־תשחת לדוד מכתם בשלח שאול וישמרו את־הבית להמיתו',
...
#  63: ['מזמור לדוד בהיותו במדבר יהודה',
...
#  66: ['למנצח שיר מזמור הריעו לאלהים כל־הארץ',
#   'זמרו כבוד־שמו שימו כבוד תהלתו',
#   'אמרו לאלהים מה־נורא מעשיך ברב עזך יכחשו לך איביך',
#   'כל־הארץ ישתחוו לך ויזמרו־לך יזמרו שמך סלה',
#   'לכו וראו מפעלות אלהים נורא עלילה על־בני אדם',
#   'הפך ים ליבשה בנהר יעברו ברגל שם נשמחה־בו',
#   'משל בגבורתו עולם עיניו בגוים תצפינה הסוררים אל־ירומו למו סלה',
...
#  71: ['בך־יהוה חסיתי אל־אבושה לעולם',
...
#   'אשר הראיתני צרות רבות ורעות תשוב תחייני ומתהמות הארץ תשוב תעלני',
#   'תרב גדלתי ותסב תנחמני',
#   'גם־אני אודך בכלי־נבל אמתך אלהי אזמרה לך בכנור קדוש ישראל',
#   'תרננה שפתי כי אזמרה־לך ונפשי אשר פדית',
#   'גם־לשוני כל־היום תהגה צדקתך כי־בשו כי־חפרו מבקשי רעתי'],
#  72: ['לשלמה א\u200dלהים משפטיך למלך תן וצדקתך לבן־מלך',
...
#  73: ['מזמור לאסף אך טוב לישראל אלהים לברי לבב',
#   'ואני כמעט נטיו רגלי כאין שפכו אשרי',
...
#   'לכן ישוב עמו הלם ומי מלא ימצו למו',
...
#  74: ['משכיל לאסף למה אלהים זנחת לנצח יעשן אפך בצאן מרעיתך',
#   'זכר עדתך קנית קדם גאלת שבט נחלתך הר־ציון זה שכנת בו',
#   'הרימה פעמיך למשאות נצח כל־הרע אויב בקדש',
#   'שאגו צרריך בקרב מועדך שמו אותתם אתות',
#   'יודע כמביא למעלה בסבך־עץ קרדמות',
#   'ועתה פתוחיה יחד בכשיל וכילפת יהלמון',
...
#  75: ['למנצח אל־תשחת מזמור לאסף שיר',
...
#  76: ['למנצח בנגינת מזמור לאסף שיר',
...
#   'אזכור מעללי־יה כי־אזכרה מקדם פלאך',
...
#   'בים דרכך ושבילך במים רבים ועקבותיך לא נדעו',
#   'נחית כצאן עמך ביד־משה ואהרן'],
#  78: ['משכיל לאסף האזינה עמי תורתי הטו אזנכם לאמרי־פי',
...
#  79: ['מזמור לאסף א\u200dלהים באו גוים בנחלתך טמאו את־היכל קדשך שמו את־ירושלם לעיים',
...
#   'למה יאמרו הגוים איה א\u200dלהיהם יודע בגוים לעינינו נקמת דם־עבדיך השפוך',
...
#  80: ['למנצח אל־ששנים עדות לאסף מזמור',
...
#  82: ['מזמור לאסף א\u200dלהים נצב בעדת־אל בקרב אלהים ישפט',
...
#  84: ['למנצח על־הגתית לבני־קרח מזמור',
...
#  85: ['למנצח לבני־קרח מזמור',
#   'רצית יהוה ארצך שבת שבית יעקב',
...
#  86: ['תפלה לדוד הטה־יהוה אזנך ענני כי־עני ואביון אני',
...
#  87: ['לבני־קרח מזמור שיר יסודתו בהררי־קדש',
...
#  88: ['שיר מזמור לבני קרח למנצח על־מחלת לענות משכיל להימן האזרחי',
...
#  90: ['תפלה למשה איש־האלהים א\u200dדני מעון אתה היית לנו בדר ודר',
...
#  91: ['ישב בסתר עליון בצל שדי יתלונן',
...
#  93: ['יהוה מלך גאות לבש לבש יהוה עז התאזר אף־תכון תבל בל־תמוט',
...
#  94: ['אל־נקמות יהוה אל נקמות הופיע',
...
#  95: ['לכו נרננה ליהוה נריעה לצור ישענו',
...
#  96: ['שירו ליהוה שיר חדש שירו ליהוה כל־הארץ',
...
#  97: ['יהוה מלך תגל הארץ ישמחו איים רבים',
...
#  98: ['מזמור שירו ליהוה שיר חדש כי־נפלאות עשה הושיעה־לו ימינו וזרוע קדשו',
...
#  99: ['יהוה מלך ירגזו עמים ישב כרובים תנוט הארץ',
...
#  100: ['מזמור לתודה הריעו ליהוה כל־הארץ',
...
#  101: ['לדוד מזמור חסד־ומשפט אשירה לך יהוה אזמרה',
...
#   'מלשני בסתר רעהו אותו אצמית גבה־עינים ורחב לבב אתו לא אוכל',
...
#  102: ['תפלה לעני כי־יעטף ולפני יהוה ישפך שיחו',
...
#  103: ['לדוד ברכי נפשי את־יהוה וכל־קרבי את־שם קדשו',
...
#  104: ['ברכי נפשי את־יהוה יהוה אלהי גדלת מאד הוד והדר לבשת',
...
#  105: ['הודו ליהוה קראו בשמו הודיעו בעמים עלילותיו',
...
#  106: ['הללויה הודו ליהוה כי־טוב כי לעולם חסדו',
...
#  107: ['הדו ליהוה כי־טוב כי לעולם חסדו',
...
#   'הבה־לנו עזרת מצר ושוא תשועת אדם',
#   'באלהים נעשה־חיל והוא יבוס צרינו'],
#  109: ['למנצח לדוד מזמור אלהי תהלתי אל־תחרש',
...
#  110: ['לדוד מזמור נאם יהוה לאדני שב לימיני עד־אשית איביך הדם לרגליך',
...
#  111: ['הללו יה אודה יהוה בכל־לבב בסוד ישרים ועדה',
...
#  112: ['הללו יה אשרי־איש ירא את־יהוה במצותיו חפץ מאד',
...
#  113: ['הללו יה הללו עבדי יהוה הללו את־שם יהוה',
...
#  114: ['בצאת ישראל ממצרים בית יעקב מעם לעז',
...
#  115: ['לא לנו יהוה לא לנו כי־לשמך תן כבוד על־חסדך על־אמתך',
...
#  116: ['אהבתי כי־ישמע יהוה את־קולי תחנוני',
...
#  117: ['הללו את־יהוה כל־גוים שבחוהו כל־האמים',
#   'כי גבר עלינו חסדו ואמת־יהוה לעולם הללו־יה'],
#  118: ['הודו ליהוה כי־טוב כי לעולם חסדו',
...
#  119: ['אשרי תמימי־דרך ההלכים בתורת יהוה',
...
#  120: ['שיר המעלות אל־יהוה בצרתה לי קראתי ויענני',
#   'יהוה הצילה נפשי משפת־שקר מלשון רמיה',
#   'מה־יתן לך ומה־יסיף לך לשון רמיה',
#   'חצי גבור שנונים עם גחלי רתמים',
#   'אויה־לי כי־גרתי משך שכנתי עם־אהלי קדר',
#   'רבת שכנה־לה נפשי עם שונא שלום',
#   'א\u200dני־שלום וכי אדבר המה למלחמה'],
#  121: ['שיר למעלות אשא עיני אל־ההרים מאין יבא עזרי',
...
#  122: ['שיר המעלות לדוד שמחתי באמרים לי בית יהוה נלך',
...
#  123: ['שיר המעלות אליך נשאתי את־עיני הישבי בשמים',
...
#  124: ['שיר המעלות לדוד לולי יהוה שהיה לנו יאמר־נא ישראל',
...
#  125: ['שיר המעלות הבטחים ביהוה כהר־ציון לא־ימוט לעולם ישב',
...
#  126: ['שיר המעלות בשוב יהוה את־שיבת ציון היינו כחלמים',
...
#  127: ['שיר המעלות לשלמה אם־יהוה לא־יבנה בית שוא עמלו בוניו בו אם־יהוה לא־ישמר־עיר שוא שקד שומר',
...
#  128: ['שיר המעלות אשרי כל־ירא יהוה ההלך בדרכיו',
...
#  129: ['שיר המעלות רבת צררוני מנעורי יאמר־נא ישראל',
#   'רבת צררוני מנעורי גם לא־יכלו לי',
#   'על־גבי חרשו חרשים האריכו למעניתם',
...
#  130: ['שיר המעלות ממעמקים קראתיך יהוה',
...
#  131: ['שיר המעלות לדוד יהוה לא־גבה לבי ולא־רמו עיני ולא־הלכתי בגדלות ובנפלאות ממני',
#   'אם־לא שויתי ודוממתי נפשי כגמל עלי אמו כגמל עלי נפשי',
#   'יחל ישראל אל־יהוה מעתה ועד־עולם'],
#  132: ['שיר המעלות זכור־יהוה לדוד את כל־ענותו',
...
#  133: ['שיר המעלות לדוד הנה מה־טוב ומה־נעים שבת אחים גם־יחד',
...
#  134: ['שיר המעלות הנה ברכו את־יהוה כל־עבדי יהוה העמדים בבית־יהוה בלילות',
#   'שאו־ידכם קדש וברכו את־יהוה',
#   'יברכך יהוה מציון עשה שמים וארץ'],
#  135: ['הללו יה הללו את־שם יהוה הללו עבדי יהוה',
...
#  136: ['הודו ליהוה כי־טוב כי לעולם חסדו',
...
#  137: ['על נהרות בבל שם ישבנו גם־בכינו בזכרנו את־ציון',
...
#  138: ['לדוד אודך בכל־לבי נגד אלהים אזמרך',
...
#  139: ['למנצח לדוד מזמור יהוה חקרתני ותדע',
...
#   'ימוטו עליהם גחלים באש יפלם במהמרות בל־יקומו',
#   'איש לשון בל־יכון בארץ איש־חמס רע יצודנו למדחפת',
#   'ידעתי כי־יעשה יהוה דין עני משפט אבינים',
#   'אך צדיקים יודו לשמך ישבו ישרים את־פניך'],
#  141: ['מזמור לדוד יהוה קראתיך חושה לי האזינה קולי בקראי־לך',
...
#  142: ['משכיל לדוד בהיותו במערה תפלה',
...
#  143: ['מזמור לדוד יהוה שמע תפלתי האזינה אל־תחנוני באמנתך ענני בצדקתך',
...
#  144: ['לדוד ברוך יהוה צורי המלמד ידי לקרב אצבעותי למלחמה',
...
#  145: ['תהלה לדוד ארוממך אלוהי המלך ואברכה שמך לעולם ועד',
...
#  147: ['הללו יה כי־טוב זמרה אלהינו כי־נעים נאוה תהלה',
...
#  148: ['הללו יה הללו את־יהוה מן־השמים הללוהו במרומים',
...
#  149: ['הללו יה שירו ליהוה שיר חדש תהלתו בקהל חסידים',
...
#  150: ['הללו יה הללו־אל בקדשו הללוהו ברקיע עזו',
